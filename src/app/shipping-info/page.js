const shippingHighlights = [
  {
    ...
    text: "Orders are usually processed within 1 to 2 working days after confirmation.",
  },
  {
    title: "3-5 day delivery",
    text: "Standard shipping usually takes 3 to 5 working days after dispatch.",
  },
  {
    title: "Pakistan coverage",
    text: "We deliver to major cities and many towns through third-party courier partners.",
  },
];
...
const shippingMethods = [
  {
    ...
    charges:
      "Free on eligible promotional quantities; otherwise shown at checkout",
  },
];
...
const shippingSections = [
  {
    ...
    paragraphs: [
      "Orders for StackSmart Organizer are usually processed within 1 to 2 working days after confirmation.",
      "Orders placed on weekends or public holidays are processed on the next working day.",
      "You may receive an order confirmation by phone, WhatsApp, SMS, or email, followed by tracking details once dispatched.",
    ],
  },
  {
    number: "02",
    title: "Delivery Time and Charges",
  ...
  },
  {
    ...
    paragraphs: [
      "We deliver to major cities and many towns across Pakistan through third-party courier partners.",
    ],
  },
  {
    number: "04",
    ...
    paragraphs: [
      "Once your order is shipped, we will share tracking information so you can monitor delivery progress through the assigned courier.",
    ],
  },
  {
    number: "05",
    ...
    paragraphs: [
      "If a parcel is returned because of an incorrect address, unavailable recipient, repeated failed delivery attempts, or refusal to accept, re-shipping charges may apply.",
    ],
  },
  {
    number: "06",
    ...
    bullets: [
      "Delivery timelines may be longer for remote areas, weather disruptions, or holiday periods.",
      "Please ensure your phone number and address are accurate so the courier can complete delivery smoothly.",
      "Cash on Delivery availability depends on serviceable areas and courier rules.",
    ],
  },
  {
    number: "07",
...
export const metadata = {
  title: "Shipping Policy | RUXBUX",
  description:
    "Read the RUXBUX shipping policy for StackSmart Organizer processing times, delivery timelines, charges, tracking, delivery areas, and support.",
};
        ...
        <div className="mx-auto grid max-w-6xl items-center gap-8 px-4 py-12 sm:px-6 sm:py-16 lg:grid-cols-[1fr_340px] lg:px-8 lg:py-20">
          <div className="text-center lg:text-left">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-sm leading-7 text-[#334155] sm:text-lg lg:mx-0">
              Processing, delivery, tracking, and support details for your
              StackSmart Organizer order.
            </p>
          ...
          <div className="mx-auto w-full max-w-sm rounded-2xl border border-[#E2C9A5] bg-white/80 p-5 shadow-[0_20px_70px_rgba(8,38,74,0.10)] backdrop-blur sm:p-6 lg:mx-0">
            ...
            <p className="mt-3 text-sm leading-7 text-[#334155]">
              Orders are typically processed in 1 to 2 working days, then
              delivered in 3 to 5 working days through courier partners.
            </p>
          </div>
        </div>
      </section>
            ...
            {shippingSections.map((section, index) => (
              <section
                ...
                className={`flex min-w-0 flex-col gap-3 min-[420px]:flex-row min-[420px]:gap-4 sm:gap-6 ${
                  index !== shippingSections.length - 1
                ...
                <div className="min-w-0">
                  ...
                  {section.table && (
                    <div className="mt-4 overflow-hidden rounded-2xl border border-[#EADCC8]">
                      <div className="hidden bg-[#FFF8ED] px-4 py-3 text-xs font-bold uppercase tracking-[0.12em] text-[#8A5B20] sm:grid sm:grid-cols-[0.9fr_0.75fr_1.35fr]">
                      ...
                      {section.table.map((row) => (
                        <div
                          key={row.method}
                          className="grid gap-3 border-t border-[#EADCC8] px-4 py-4 text-sm leading-6 text-[#26364A] first:border-t-0 sm:grid-cols-[0.9fr_0.75fr_1.35fr] sm:gap-4 sm:first:border-t"
                        >
                          <div>
                            <span className="block text-xs font-bold uppercase tracking-[0.12em] text-[#8A5B20] sm:hidden">
                              Shipping Method
                            </span>
                            <span className="font-bold text-[#08264A]">
                              {row.method}
                            </span>
                          </div>
                          <div>
